...
const op_t op_tab[] = {
    ...
    {"lldi", 3, {T_REG | T_DIR | T_IND, T_REG | T_DIR, T_REG}, 14, 50,
        "long load indirect", true, true, &load_long_ind_instr},
    {"lfork", 1, {T_DIR}, 15, 1000, "long fork", false, true, &fork_long_instr},
    {"print", 1, {T_REG}, 16, 2, "print character", true, false, &print_instr},
