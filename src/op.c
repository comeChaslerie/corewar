...
const op_t op_tab[] = {
    ...
    {"st", 2, {T_REG, T_REG | T_IND}, 3, 5, "store", false, false, &store_instr},
    {"add", 3, {T_REG, T_REG, T_REG}, 4, 10, "addition", false, false, &add_instr},
    {"sub", 3, {T_REG, T_REG, T_REG}, 5, 10, "subtraction", false, false, &sub_instr},
    {"and", 3, {T_REG | T_DIR | T_IND, T_REG | T_DIR | T_IND, T_REG}, 6, 6,
        "binary and (and  r1, r2, r3   r1&r2 -> r3", false, false, &bin_and_instr},
    {"or", 3, {T_REG | T_DIR | T_IND, T_REG | T_DIR | T_IND, T_REG}, 7, 6,
        "binary or  (or   r1, r2, r3   r1 | r2 -> r3", false, false, &bin_or_instr},
